<style>
    ...
    #header-app .items-trans a {
        font-size: 27px;
        text-decoration: none;
        color: rgba(201, 222, 246, 0.9);
    }

    #header-app .items-trans a:hover {
        transition: 0.1s;
        color: rgba(139, 186, 243, 0.9);
    }

    #header-app .items-white a {
        font-size: 27px;
        text-decoration: none;
        color: rgba(8, 43, 83, 0.9);
    }

    #header-app .items-white a:hover {
        transition: 0.1s;
    ...
    #header-app .contact a {
        text-decoration: none;
    }

    #header-app .contact-trans a {
        color: rgba(201, 222, 246, 0.9);
    }

    #header-app .contact-trans a:hover {
        color: rgba(139, 186, 243, 0.9);
    }

    #header-app .contact-white a {
        color: rgba(8, 43, 83, 0.9);
    }

    #header-app .contact-white a:hover {
        color: rgba(88, 143, 211, 0.9);
    }
