<?php $bgImg = $screen == 'web' ? $bgHomeWeb : $bgHomeMobile ?>
<div class="head" style="background-image: url('<?= $bgImg ?>')">
    <div class="bg-trans">
        <div class="v-center trans-content text-center">
            ...
            <button type="button" class="btn btn-light btn-cmd contact-<?= $screen ?>-cls" data-link="home">Passez votre commande</button>
        </div>
    </div>
</div>
